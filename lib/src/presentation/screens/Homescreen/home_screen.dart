                    ...
                    child: Column(
                      children: [
                        WardBoothDetails(
                          ...
                          percentagevote: ctrl.percentage.value,
                          remainvote: ctrl.remainingvoter.value,
                          totalvote: '${ctrl.totalvoters.value}',
                          date: ctrl.date.value,
                        ...
                        AssignedBoothSection(
                          ...
                          ourtotalvoters: ctrl.ourVoters.value,
                          voted: ctrl.ourVoted.value,
                        ),
                        const SizedBox(height: 24),
                        Padding(
